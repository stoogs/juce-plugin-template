...
- [ ] 02-02-PLAN.md — web/index.html minimal scaffold with JS↔C++ bridge documentation
- [ ] 02-03-PLAN.md — PluginEditor WebBrowserComponent wiring and CMakeLists.txt updates
